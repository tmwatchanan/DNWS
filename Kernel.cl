...
__kernel void PrewittOperator(__read_only image2d_t srcImg, __write_only image2d_t dstImg)
{
  uint luma_option = 0; //change luminance choice for different formula used for converting rgb to grey
  __constant int flipped_prewitt_kernel_x[3][3] =
  {
    {1, 0, -1},
    {1, 0, -1},
    {1, 0, -1}
  };
  __constant int flipped_prewitt_kernel_y[3][3] =
  {
    {1, 1, 1},
    {0, 0, 0},
    {-1, -1, -1}
  ...
  int *gradient_kernel_x = flipped_prewitt_kernel_x;
  int *gradient_kernel_y = flipped_prewitt_kernel_y;
